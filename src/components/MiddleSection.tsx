export default function MiddleSection() {
    return (
        <div className="flex flex-col items-center gap-y-7 absolute z-50 top-1/3 left-0 right-0 ml-auto mr-auto">
            <div className="flex-col flex gap-y-5">
                <p className="text-5xl font-bold text-center max-sm:text-2xl">We’ve really sped up our workflow</p>
                <p className="text-lg text-center font-medium md:px-5 max-sm:text-sm max-sm:px-9">We’ve just released a new update! Check out the all new dashboard view.
                    Pages and now load faster.you can try us for free for 30 days.</p>
                <p className="text-lg text-center font-medium md:px-5">Join 4,000+ companies already growing</p>
            </div>
            <div className="flex flex-row items-center gap-x-6 max-sm:flex-col max-sm:gap-y-7">
